...
const CourseDetailsModal = ({ isOpen, onClose, course, onApply }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto relative font-dm-sans">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-gray-400 hover:text-gray-600 z-10 bg-white/80 p-2 rounded-full"
        >
          <FaTimes size={24} />
        </button>
            ...
            <div className="p-8 text-white w-full">
              ...
              <div className="flex items-center gap-6 text-sm text-gray-200">
                <span className="flex items-center gap-1">
                  ...
                  {course.students || "Many"} Students
                </span>
                <span className="flex items-center gap-1">
                  <FaAward /> Certified Course
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 sticky top-4">
              ...
              <button
                ...
                className="w-full bg-brand-primary text-white font-bold py-3.5 rounded-lg hover:bg-brand-accent transition-all shadow-lg hover:shadow-xl"
              >
                Apply Now
              </button>
